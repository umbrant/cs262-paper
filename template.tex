...
The first user application we chose for testing was a simple Qt web browser based on WebKit. Browsers are probably one of the most commonly used and installed user applications, making a browser a representative choice as a "real world" application. Browsers also have the benefit of having numerous benchmark and test suites, such as SunSpider\cite{sunspider}, Kraken\cite{kraken}, and V8 \cite{v8benchmark}.

of the two applications chosen for testing was a simple web browser based on the WebKit browser engine. 
