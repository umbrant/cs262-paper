...
Table \ref{tab:nbb_table} summarizes the latency of using our implementation of channels with varying message sizes. As we can see, the latency of sending a message from one point to another is very low.
